...
def parse_args():
    ...
    parser.add_argument('--vq_w', type=float, default=1.0, help='vq pretrain weight')
    parser.add_argument('--vqa_w', type=float, default=1.0, help='vqa pretrain weight')
    parser.add_argument('--qa_w', type=float, default=1.0, help='qa pretrain weight')
    parser.add_argument('--va_w', type=float, default=1.0, help='va2 pretrain weight')
