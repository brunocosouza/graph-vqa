...
from dataset_modify import Dictionary, PVQAFeatureDataset
...
from model.position_emb import prepare_graph_variables, build_graph
...
if __name__ == '__main__':
    ...
    dictionary = Dictionary.load_from_file(join(args.data_folder, 'pvqa/pvqa_dictionary.pkl'))
    ...
    eval_loader = DataLoader(
        eval_dset, batch_size, shuffle=False, collate_fn=utils.trim_collate)
